...
def show_result():
    packet_list_tree.insert("", 'end', 1, text='1', values=(1, 2, 3, 4, 5, 6, 7,999))
    packet_list_tree.insert("", 'end', 2, text='2', values=(8, 9, 10, 11, 12, 13, 14,888))
...
# 数据包列表区列标题
packet_list_tree["columns"] = ("DeviceDescription", "DeviceSN", "CommandPort", "HttpPort", "MAC", "IPv4Address", "SoftwareVersion", "DSPVersion")
